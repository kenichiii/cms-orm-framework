...
if (("addEventListener" in window) && ("FileReader" in window) && ("FormData" in window)) {
 ...
 $("#znacky-foto-file-output").html("Upload obrázku není Vaším prohlížečem podporován");
}

$("#znacky-foto-file-upload").hide();
$("#znacky-foto-button-upload").unbind('click').click(function(){
    $("#znacky-foto-file-upload").trigger('click');
    return false;
});    
    
var 
    filesUpload = document.getElementById("znacky-foto-file-upload"),
    fileList = document.getElementById("znacky-foto-file-output")
  ;
...
function uploadFile (file) {
    ...
    progressBarContainer.className = "znacky-foto-progress-bar-container";
    progressBar.className = "znacky-foto-progress-bar";
    ...
    formData.append('photo', file, file.name);
        ...
        xhr.open("post", $('#znacky-foto-upload-form').attr('action'), true);
...
{
    //delete button
    $("#znacky-foto-delete").unbind('click').click(function(){
           var that = this; 
...
function loadFoto()
{
    $.get($("#znacky-foto-url").val(),{},function(img){    
        $(".znacky-foto-img-holder").html(img);
        activateFotoListeners();
    });
}