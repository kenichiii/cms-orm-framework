...
if (("addEventListener" in window) && ("FileReader" in window) && ("FormData" in window)) {
 ...
 $("#page-foto-file-output").html("Upload obrázku není Vaším prohlížečem podporován");
}

$("#page-foto-file-upload").hide();
$("#page-foto-button-upload").unbind('click').click(function(){
    $("#page-foto-file-upload").trigger('click');
    return false;
});    
    
var 
    filesUpload = document.getElementById("page-foto-file-upload"),
    fileList = document.getElementById("page-foto-file-output")
  ;
...
function uploadFile (file) {
    ...
    progressBarContainer.className = "page-foto-progress-bar-container";
    progressBar.className = "page-foto-progress-bar";
    ...
    formData.append('photo', file, file.name);
        ...
        xhr.open("post", $('#page-foto-upload-form').attr('action'), true);
...
{
    //delete button
    $("#page-foto-delete").unbind('click').click(function(){
           var that = this; 
...
function loadFoto()
{
    $.get($("#page-foto-url").val(),{},function(img){    
        $(".page-foto-img-holder").html(img);
        activateFotoListeners();
    });
}