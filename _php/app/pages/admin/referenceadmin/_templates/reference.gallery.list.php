       ...
       <div class='gallery-img-texts'>           
           <div class='texts-view'>
              ...
              <div class='texts-actions' style="padding-top: 15px">
                  <a class="gallery-edit button-link" href='<?php echo App::getIns()->setAjaxLink("_curr","reference-gallery-item-edit",array("id"=>$img->getId()->getValue())); ?>'>upravit</a>
                       
                  <a class="gallery-delete button-link" href='<?php echo App::getIns()->setActionLink("_curr","reference-gallery-delete",array("id"=>$img->getId()->getValue())) ?>'>smazat</a>
              </div>
           </div>
       </div>    
    </div>
