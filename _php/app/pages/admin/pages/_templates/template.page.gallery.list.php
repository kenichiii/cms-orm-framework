    ...
    <div class='gallery-img' id="photo_<?php echo $img->getId()->getValue(); ?>">
       ...
       <div class='gallery-img-texts'>           
           <div class='texts-view'>
              ...
              <div><b>Odkaz:</b> <?php echo $img->getLink()->getValue() ? $img->getLink()->getValue() : $img->getH1()->getValue() ?></div>              
              ...
              <div class='texts-actions' style="padding-top: 15px">
                  <a class="gallery-edit button-link" href='<?php echo App::getIns()->setAjaxLink("_curr","page-gallery-item-edit",array("id"=>$img->getId()->getValue())); ?>'>upravit</a>
                       
                  <a class="gallery-delete button-link" href='<?php echo App::getIns()->setActionLink("_curr","page-gallery-delete",array("id"=>$img->getId()->getValue())) ?>'>smazat</a>
              </div>
           </div>
       </div>    
    </div>
