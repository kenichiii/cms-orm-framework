...
?>
      ...
      <div class="model-form-holder">
        <form id="userformedit" action="<?php echo App::getIns()->setActionLink('_curr','my-account') ?>" method="post">                        
...
<div class="model-form-row">
    ...
    <div class="model-form-collum-cell"> 
        <?php if($ownersubj->getId()->getValue()==$bean->get('subjectid')->getValue()) echo $ownersubj->getH1()->getValue() ?>
        <?php if($devsubj->getId()->getValue()==$bean->get('subjectid')->getValue())echo $devsubj->getH1()->getValue() ?>
        </select> 
    </div>            
</div>  
...
<div class="model-form-row">
    ...
    <div class="model-form-collum-cell"> 
           ...
           <?php foreach ($adminsubroles as $sk=>$s) {?>
               <?php echo $s->getId()->getValue()==$adminsubroleid ? $s->getH1()->getValue() : ''; ?>
           <?php } ?>
