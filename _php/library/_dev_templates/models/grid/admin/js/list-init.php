...
var options = {
    ...
    add_form_id:'<?php echo $formnew->getName(); ?>',
    add_title:'<?php echo $formnew->getTitle(); ?>',
               ...
               ?>  
                                            ...
                                            <?php if($pcoll = $formedit->getModel()->isPhotoAble()) { ?>
                                                          ...
                                                          $("#<?php echo $formedit->getModel()->getModelName().'_file_'.$pcoll->getCollum(); ?>").pfcFileAdmin({
                                                            succ:function(res){
                                                                $('.<?php echo $formedit->getModel()->getGrid()->getName(); ?>-holder').pfcGridAdmin(options).load();
 ...
 $('.<?php echo $grid->getName(); ?>-holder').pfcGridAdmin(options).init(); 
//end pfcGridAdmin
